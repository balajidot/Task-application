...
export default function HabitsView() {
  ...
  // ✅ NEW: Personal best streak calculator
  const getPersonalBest = (habit) => {
    const keys = Object.keys(habit.checked || {}).filter(k => habit.checked[k]).sort();
              ...
              <div style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
                {streak > 0 && (
                  <span style={{
                    ...
                    🔥 {streak}d streak  |  🏆 Best: {getPersonalBest(habit)}d
                  </span>
                )}
